...
export default function PrivacyPage() {
  return (
    <main className="min-h-screen bg-linear-to-b from-surface-container to-surface-bright py-16">
      <Container>
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-2">
              ...
              <p className="text-muted-foreground text-sm leading-relaxed">
                Esta página resume como o Gateon trata dados pessoais para
                automação de acesso a grupos, segurança da conta e comunicação
          ...
          <Card>
            ...
            <CardContent className="space-y-3 text-muted-foreground text-sm leading-relaxed">
              <p>
                ...
                portabilidade, anonimização, revogação de consentimento ou
