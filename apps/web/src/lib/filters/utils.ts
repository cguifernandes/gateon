...
export function areGroupsUrlFiltersEqual(
  ...
  return (
    ...
    areStringIdListsEqual(a.stripeConnectionIds, b.stripeConnectionIds) &&
    areDateRangesEqual(a.connectedRange, b.connectedRange)
  );
}

function areStringIdListsEqual(a: string[], b: string[]): boolean {
...
export function areMembersUrlFiltersEqual(
  ...
  return (
    ...
    areStringIdListsEqual(a.telegramChatIds, b.telegramChatIds) &&
